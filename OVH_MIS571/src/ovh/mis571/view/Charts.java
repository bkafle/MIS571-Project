package ovh.mis571.view;

import ovh.mis571.util.Calendar;
...
public class Charts {
	...
	private static XYMultipleSeriesDataset createDataSet(List<Calendar> CalendarList) {
		XYMultipleSeriesDataset mDataset = new XYMultipleSeriesDataset();
		CategorySeries series = new CategorySeries("Number of Checkout / Month");
		for (Calendar Calendar : CalendarList) {
			if (Calendar.getNumber() > yMaxNum) {
				yMaxNum = Calendar.getNumber();
			}
			series.add(Calendar.getMonth() + "", Calendar.getNumber());
		}
	...
	public static Intent getBarChart(Context context, String title,
		...
		return ChartFactory.getBarChartIntent(context, createDataSet(CalendarList),
	...
	public static Intent getLineChart(Context context, String title,
		...
		return ChartFactory.getLineChartIntent(context,
				createDataSet(CalendarList), mRenderer);
	}
